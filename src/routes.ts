...
router.delete("/remover/voluntario", VoluntarioController.remover); // Rota para exluir um voluntário
...
router.delete("/remover/participacao", ParticipacaoController.remover); // Rota para excluir uma participação
...
router.delete("/remover/trabalho", TrabalhoController.remover); // Rota para excluir um trabalho
